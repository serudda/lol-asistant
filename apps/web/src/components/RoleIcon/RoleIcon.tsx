...
const ICON_PATHS: Record<LoLChampionRole, React.ReactNode | null> = {
 ...
 *
 * Colour can be changed via any Tailwind `text-*` utility
 * (or inline style) because every path uses
 * `fill="currentColor"`.
 */
